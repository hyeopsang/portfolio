                        ...
                        <div className={`tp1 ${isFlipped ? 'flipped' : ''}`} onClick={handleClick}>
                            ...
                            <div className="tp1_back">
                                ...
                                <div className="detail">
                                    <h3>개요</h3>
                                    <p>비오는 날 날씨에 어울리는 플레이리스트를 찾아 듣던게 생각나서 자동으로<br/>
                                ...
                                <p>Geolocation API를 사용하여 현재 위치의 경도와 위도를 가져오고<br/>
                                    ...
                                    구현하였고 유트브 라이브러리를 사용해서 노래 뮤비의 링크들을<br/> 모아서 플레이리스트들을 만들고 Openweather API의
                                    날씨 데이터에<br/> 연결하여 날씨에 따라 다른 플레이리스트가 재생이 되도록 만들었습니다.</p>
                                </div>
                            </div>
                        </div>
